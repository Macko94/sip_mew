...
var format_Projekt14E1_lokalizacje_turbin_15 = new ol.format.GeoJSON();
var features_Projekt14E1_lokalizacje_turbin_15 = format_Projekt14E1_lokalizacje_turbin_15.readFeatures(json_Projekt14E1_lokalizacje_turbin_15, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:2180'});
var jsonSource_Projekt14E1_lokalizacje_turbin_15 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Projekt14E1_lokalizacje_turbin_15.addFeatures(features_Projekt14E1_lokalizacje_turbin_15);
var lyr_Projekt14E1_lokalizacje_turbin_15 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Projekt14E1_lokalizacje_turbin_15, 
                style: style_Projekt14E1_lokalizacje_turbin_15,
                interactive: true,
                title: '<img src="styles/legend/Projekt14E1_lokalizacje_turbin_15.png" /> Projekt14E1_lokalizacje_turbin'
            });
var format_Projekt14E1_lokalizacje_MST_16 = new ol.format.GeoJSON();
var features_Projekt14E1_lokalizacje_MST_16 = format_Projekt14E1_lokalizacje_MST_16.readFeatures(json_Projekt14E1_lokalizacje_MST_16, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:2180'});
var jsonSource_Projekt14E1_lokalizacje_MST_16 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Projekt14E1_lokalizacje_MST_16.addFeatures(features_Projekt14E1_lokalizacje_MST_16);
var lyr_Projekt14E1_lokalizacje_MST_16 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Projekt14E1_lokalizacje_MST_16, 
                style: style_Projekt14E1_lokalizacje_MST_16,
                interactive: true,
                title: '<img src="styles/legend/Projekt14E1_lokalizacje_MST_16.png" /> Projekt14E1_lokalizacje_MST'
            });
var layersList = [
    new ol.layer.Group({
        title: 'Mapa_bazowa',
...
lyr_Projekt14E1_kable_wewnetrzne_14.set('fieldAliases', {'id': 'id', 'dlugosc_m': 'dlugosc_m', 'napiecie_k': 'napiecie_k', });
lyr_Projekt14E1_lokalizacje_turbin_15.set('fieldAliases', {'id': 'id', 'nazwa': 'nazwa', 'model_turb': 'model_turb', 'wys_wiezy': 'wys_wiezy', 'rotor_d': 'rotor_d', 'Baltykbaty': 'Baltykbaty', });
lyr_Projekt14E1_lokalizacje_MST_16.set('fieldAliases', {'id': 'id', 'batymetria': 'batymetria', });
...
lyr_Projekt14E1_kable_wewnetrzne_14.set('fieldImages', {'id': '', 'dlugosc_m': '', 'napiecie_k': '', });
lyr_Projekt14E1_lokalizacje_turbin_15.set('fieldImages', {'id': '', 'nazwa': '', 'model_turb': '', 'wys_wiezy': '', 'rotor_d': '', 'Baltykbaty': '', });
lyr_Projekt14E1_lokalizacje_MST_16.set('fieldImages', {'id': '', 'batymetria': '', });
...
lyr_wnioski_pod_kable_MFW_12.set('fieldLabels', {'id': 'inline label', 'inwestor': 'inline label', 'nr_inwesto': 'no label', 'data_wnios': 'inline label', 'status_pos': 'inline label', 'rodzaj_dok': 'inline label', 'data_dokum': 'no label', 'numer_doku': 'no label', 'organ_wyda': 'no label', 'podstawa_p': 'no label', 'opis_rozst': 'no label', 'status_dok': 'no label', 'data_ostat': 'no label', 'full_name': 'no label', 'short_name': 'no label', 'comments': 'no label', 'notes': 'no label', 'owf_cable_': 'no label', 'sys_node_c': 'no label', 'sys_versio': 'no label', 'sys_vers_1': 'no label', 'sys_date_a': 'no label', 'sys_data_a': 'no label', 'sys_data_e': 'no label', 'document_i': 'no label', });
lyr_PSzW_bufor500m_13.set('fieldLabels', {'id': 'inline label', 'full_name': 'inline label', 'area_km2': 'header label', });
lyr_Projekt14E1_kable_wewnetrzne_14.set('fieldLabels', {'id': 'inline label', 'dlugosc_m': 'inline label', 'napiecie_k': 'inline label', });
lyr_Projekt14E1_lokalizacje_turbin_15.set('fieldLabels', {'id': 'inline label', 'nazwa': 'inline label', 'model_turb': 'header label', 'wys_wiezy': 'inline label', 'rotor_d': 'inline label', 'Baltykbaty': 'inline label', });
lyr_Projekt14E1_lokalizacje_MST_16.set('fieldLabels', {'id': 'inline label', 'batymetria': 'inline label', });
lyr_Projekt14E1_lokalizacje_MST_16.on('precompose', function(evt) {
