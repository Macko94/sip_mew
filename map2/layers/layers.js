...
ol.proj.get("EPSG:2180").setExtent([238447.523431, 719895.907642, 267744.786912, 748632.755882]);
var wms_layers = [];
...
jsonSource_wrakstatku_8.addFeatures(features_wrakstatku_8);
...
var format_Projekt14E2_lokalizacje_MST_15 = new ol.format.GeoJSON();
var features_Projekt14E2_lokalizacje_MST_15 = format_Projekt14E2_lokalizacje_MST_15.readFeatures(json_Projekt14E2_lokalizacje_MST_15, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:2180'});
var jsonSource_Projekt14E2_lokalizacje_MST_15 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Projekt14E2_lokalizacje_MST_15.addFeatures(features_Projekt14E2_lokalizacje_MST_15);cluster_Projekt14E2_lokalizacje_MST_15 = new ol.source.Cluster({
  distance: 10,
  source: jsonSource_Projekt14E2_lokalizacje_MST_15
});
var lyr_Projekt14E2_lokalizacje_MST_15 = new ol.layer.Vector({
                declutter: true,
                source:cluster_Projekt14E2_lokalizacje_MST_15, 
                style: style_Projekt14E2_lokalizacje_MST_15,
                interactive: true,
                title: '<img src="styles/legend/Projekt14E2_lokalizacje_MST_15.png" /> Projekt14E2_lokalizacje_MST'
            });
var format_Projekt14E2_lokalizacje_turbin_16 = new ol.format.GeoJSON();
var features_Projekt14E2_lokalizacje_turbin_16 = format_Projekt14E2_lokalizacje_turbin_16.readFeatures(json_Projekt14E2_lokalizacje_turbin_16, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:2180'});
var jsonSource_Projekt14E2_lokalizacje_turbin_16 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Projekt14E2_lokalizacje_turbin_16.addFeatures(features_Projekt14E2_lokalizacje_turbin_16);
var lyr_Projekt14E2_lokalizacje_turbin_16 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Projekt14E2_lokalizacje_turbin_16, 
                style: style_Projekt14E2_lokalizacje_turbin_16,
                interactive: true,
                title: '<img src="styles/legend/Projekt14E2_lokalizacje_turbin_16.png" /> Projekt14E2_lokalizacje_turbin'
            });
            var layersList = [
                new ol.layer.Group({
                    title: 'Mapa_bazowa',
...
lyr_PSzW_bufor500m_13.set('fieldAliases', {'id': 'identyfikator', 'full_name': 'Nazwa obszaru', 'area_km2': 'powierzchnia [km2]', });
lyr_Projekt14E2_kable_wewnetrzne_14.set('fieldAliases', {'id': 'identyfikator', 'dlugosc': 'długość [m]', 'napiecie_k': 'napięcie kabla [kV]', });
lyr_Projekt14E2_lokalizacje_MST_15.set('fieldAliases', {'id': 'Identyfikator', 'batymetria': 'Batymetria [m]', });
lyr_Projekt14E2_lokalizacje_turbin_16.set('fieldAliases', {'id': 'Identyfikator', 'nazwa': 'Nazwa obiektu', 'model_turb': 'Model turbiny wiatrowej', 'wys_wiezy': 'Wysokość wieży [m]', 'rotor_d': 'Średnica rotora [m]', 'batymetria': 'głębokość dna [m]', });
...
lyr_PSzW_bufor500m_13.set('fieldImages', {'id': 'TextEdit', 'full_name': 'TextEdit', 'area_km2': 'TextEdit', });
lyr_Projekt14E2_kable_wewnetrzne_14.set('fieldImages', {'id': 'TextEdit', 'dlugosc': 'TextEdit', 'napiecie_k': 'TextEdit', });
lyr_Projekt14E2_lokalizacje_MST_15.set('fieldImages', {'id': 'TextEdit', 'batymetria': 'TextEdit', });
lyr_Projekt14E2_lokalizacje_turbin_16.set('fieldImages', {'id': 'TextEdit', 'nazwa': 'TextEdit', 'model_turb': 'TextEdit', 'wys_wiezy': 'TextEdit', 'rotor_d': 'TextEdit', 'batymetria': 'TextEdit', });
...
lyr_Projekt14E2_lokalizacje_MST_15.set('fieldLabels', {'id': 'inline label', 'batymetria': 'inline label', });
lyr_Projekt14E2_lokalizacje_turbin_16.set('fieldLabels', {'id': 'inline label', 'nazwa': 'inline label', 'model_turb': 'inline label', 'wys_wiezy': 'inline label', 'rotor_d': 'inline label', 'batymetria': 'inline label', });
lyr_Projekt14E2_lokalizacje_turbin_16.on('precompose', function(evt) {
